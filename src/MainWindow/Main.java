...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        SequentialTransition move1=AnimationGenerator.getMoveAnimation(bNode1,2000,100,300);
        SequentialTransition move2=AnimationGenerator.getMoveAnimation(bNode2,2000,300,300);
        ...
        //bNode2.setPosition(300,300);

        System.out.println(bNode1.getLayoutX());
        System.out.println(bNode1.getLayoutY());
        System.out.println("\n");
